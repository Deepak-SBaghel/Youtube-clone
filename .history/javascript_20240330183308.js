...
function imgchange(){
  let x = document.getElementsByClassName('images').children[0];
  let y = document.getElementsByClassName('images').childrens[1];
  // let y = document.getElementsByClassName('thisimgchange2');
  x.replaceChild(y, x.childNodes[0]);
}