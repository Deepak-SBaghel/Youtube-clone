...
function imgchange(index=0){
  const arr= ["https://source.unsplash.com/random/900x700/?a","https://source.unsplash.com/random/900x700/?b","https://source.unsplash.com/random/900x700/?c"];
  document.getElementsByClassName("img")[0].src = arr[index].src;
  let nextindex = index === x.length - 1 ? 0 : ++index;
  setInterval(imgchange,1000,nextindex);
